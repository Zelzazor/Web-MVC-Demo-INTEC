...
namespace Web.MVC.Controllers
{
    public class ClientTypesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "id,Name,Description,Enabled,CreatedAt")] ClientType clientType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "id,Name,Description,Enabled,CreatedAt")] ClientType clientType)
        {
            if (ModelState.IsValid)
            {
