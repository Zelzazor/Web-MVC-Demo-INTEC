...
namespace Web.MVC.Controllers
{
    public class ContactTypesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "id,Name,Description,Enabled,CreatedAt")] ContactType contactType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "id,Name,Description,Enabled,CreatedAt")] ContactType contactType)
        {
            if (ModelState.IsValid)
            {
